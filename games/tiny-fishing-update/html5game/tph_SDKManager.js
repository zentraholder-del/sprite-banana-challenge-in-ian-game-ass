...
*/
            ...
            var subdEnc = ["dGhldGlueWZpc2hpbmcuY29t", "MTI3LjAuMC4x","Y29vbG1hdGgtZ2FtZXMuY29t", "Y29vbG1hdGhnYW1lcy5jb20=", "Y21hdGdhbWUubG9jYWw="]; //"coolmath-games.com", "coolmathgames.com", "cmatgame.local"
            var dEnc = ["dGhldGlueWZpc2hpbmcuY29t", "MTI3LjAuMC4x","Y29vbG1hdGhnYW1lcy5jb20=", "bS5jb29sbWF0aGdhbWVzLmNvbQ==", "c3RhZ2UuY29vbG1hdGhnYW1lcy5jb20=", "bS1zdGFnZS5jb29sbWF0aGdhbWVzLmNvbQ==", "ZGV2LmNvb2xtYXRoZ2FtZXMuY29t", "bS1kZXYuY29vbG1hdGhnYW1lcy5jb20=", "bS5jbWF0Z2FtZS5sb2NhbA==", "Y21hdGdhbWUubG9jYWw=", "Y29vbG1hdGguY29t", "Y29vbG1hdGg0a2lkcy5jb20="]; //"coolmathgames.com", "m.coolmathgames.com", "stage.coolmathgames.com", "m-stage.coolmathgames.com", "dev.coolmathgames.com", "m-dev.coolmathgames.com", "m.cmatgame.local", "cmatgame.local", "coolmath.com", "coolmath4kids.com"
            var ppEnc = ["dGhldGlueWZpc2hpbmcuY29t", "MTI3LjAuMC4x","cGxheWNhbnZhcy5jb20=", "cGxheWNhbG0uY28=", "bG9jYWxob3N0"]; //"playcanvas.com", "playcalm.co", localhost
...
///////////////////////////////////////////////////////////
    ...
    launchSDKfunction(sdkType, functionName, functionParam = null) {
        ...
        if (this.sdktype == Sdkmanager.SDK_COOLMATH)
        {
            ...
            console.log("COOLMATH mode disabled for external domain");
            return;
            // coolmath
            // gameplayStart/gameplayStop/happytime
    ...
    showAd = function(adType=1)
    {
        ...
        console.log('SDK_CRAZYGAMES ' +  Sdkmanager.SDK_CRAZYGAMES)
        console.log('AD_INTERSTITIAL ' + Sdkmanager.AD_INTERSTITIAL)
        console.log('AD_REWARDED ' + Sdkmanager.AD_REWARDED)
        console.log('SDK_TESTING ' + Sdkmanager.SDK_TESTING)
        console.log('SDK_COOLMATH ' + Sdkmanager.SDK_COOLMATH)
