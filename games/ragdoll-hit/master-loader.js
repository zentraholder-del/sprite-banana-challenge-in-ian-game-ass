...
, function(t, r, n) {
    ...
    if (window.location.href.indexOf("pokiForceLocalLoader") >= 0 && (c.unity = "/unity/dist/unity.js",
    ...
    if (!a)
        throw Error('Loader "'.concat(window.config.loader, '" not found'));
    if (!window.config.unityWebglLoaderUrl) {
        ...
        switch (s) {
        case "2019":
            window.config.unityWebglLoaderUrl = 1 === f ? "UnityLoader.2019.1.js" : "UnityLoader.2019.2.js";
            break;
        default:
    ...
    try {
        ...
        window.IDBObjectStore.prototype.put = function() {
            ...
            if ("/idbfs" === this.transaction.db.name) {
                try {
                    a || (a = i(r[1]),
                    localStorage.setItem("savegame_idbfs_hash", a))
                } catch (t) {}
                var o = [].concat(r);
                return o[1] = e(r[1]),
                d.apply(this, o)
...
, function(t, r, n) {
    ...
    function o(t) {
        for (var r = Array(t.length >> 2), n = 0; n < r.length; n++)
            r[n] = 0;
