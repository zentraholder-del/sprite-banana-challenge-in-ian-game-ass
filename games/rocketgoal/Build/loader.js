            ...
            n.inflateReset = s, n.inflateReset2 = l, n.inflateResetKeep = i, n.inflateInit = function(e) {
              ...
              e: for(;;) switch(n.mode) {
                ...
                case 10:
                  ...
                  e.adler = n.check = M(c), d = c = 0, n.mode = 11;
                case 11:
                    ...
                    switch(n.last = 1 & c, --d, 3 & (c >>>= 1)) {
                      ...
                      case 1:
                        var B, B = A = void 0,
                          A = n;
                        if(Z) {
                          for(F = new T.Buf32(512), H = new T.Buf32(32), B = 0; B < 144;) A.lens[B++] = 8;
                          for(; B < 256;) A.lens[B++] = 9;
                          for(; B < 280;) A.lens[B++] = 7;
                          for(; B < 288;) A.lens[B++] = 8;
                          for(L(1, A.lens, 0, 288, F, 0, A.work, {
                              bits: 9
                            }), B = 0; B < 32;) A.lens[B++] = 5;
                        ...
                        if(A.lencode = F, A.lenbits = 9, A.distcode = H, A.distbits = 5, n.mode = 20, 6 !== t) break;
                        c >>>= 2, d -= 2;
                        break e;
                      case 2:
                        n.mode = 17;
                ...
                case 27:
                  if(n.wrap) {
                    ...
                    if(f -= l, e.total_out += f, n.total += f, f && (e.adler = n.check = (n.flags ? P : R)(n.check, o, f, i - f)), f = l, (n.flags ? c : M(c)) !== n.check) {
