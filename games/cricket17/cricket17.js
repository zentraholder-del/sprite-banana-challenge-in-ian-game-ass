(function() {
	...
	ka("Map", function(a) {
		...
		e.prototype.set = function(a, b) {
			...
			c.Ka ? c.Ka.value = b : (c.Ka = {
				...
				key: a,
				value: b
			}, c.list.push(c.Ka), this.H.qb.next = c.Ka, this.H.qb = c.Ka, this.size++);
			return this
		};
		e.prototype.delete = function(a) {
			a = d(this, a);
			return a.Ka && a.list ? (a.list.splice(a.index, 1), a.list.length || delete this.v[a.id], a.Ka.qb.next = a.Ka.next, a.Ka.next.qb = a.Ka.qb, a.Ka.head = null, this.size--,
				!0) : !1
		};
	...
	function cb(a) {
		...
		a = "https://www.google.com/gen_204?atyp=i&ct=doodle&cad=" + a + d + "&zx=" + wa();
		/^http:/i.test(a) && "https:" == window.location.protocol ? delete eb[c] : (b.src = a, db = c + 1)
	}
	var eb = [],
		db = 0;
	var fb = "StopIteration" in ma ? ma.StopIteration : {
	...
	function qb(a, b, c) {
		b instanceof pb ? (a.v = b, xb(a.v, a.H)) : (c || (b = sb(b, yb)), a.v = new pb(b, 0, a.H))
	}
	...
	function Ab(a) {
		a.H || (a.H = new hb, a.v = 0, a.S && lb(a.S, function(b, c) {
	...
	function yc(a, b) {
		if (1 == b) G(a.ka, [new J(a, 700, new v(0, 1.6, 5.3), {
			Ha: tc
		}), new I(700, r(a.v), -.95, n, function(b) {
			return zc(a, b)
		}, {
			Ha: tc
		})]);
		else if (2 == b) G(a.ka, [new J(a, 1700, new v(0, 10.4, 48.4), {
			Ha: wc
		}), new I(1700, r(a.v), 11.15, n, function(b) {
			return zc(a, b)
		}, {
			Ha: wc
		})]);
			...
			G(a.ka, [new J(a, c, fc, {
				Ha: d
			}), new I(c, r(a.v), 15.55, n, function(b) {
				return zc(a, b)
			}, {
				Ha: d
			}), new I(c, r(a.R), 0, n, function(b) {
				return Ac(a, b)
			}, {
				Ha: d
			})])
	...
	function we(a, b, c, d) {
		b instanceof v ? (a.v.x = b.x, a.v.y = b.y, a.v.z = b.z) : (a.v.x = b, a.v.y = void 0 === c ? a.v.y : c, a.v.z = void 0 === d ? a.v.z : d)
	}
	...
	function af(a) {
		...
		this.S = [];
		this.v = a.createGain();
		for (var b = k([523.25, 659.25, 587.33, 698.46, 659.25, 783.99]), c = b.next(); !c.done; c = b.next()) c = new Y({
			Cb: a,
			Ab: .1,
			Fb: 1,
			Yb: c.value,
	...
	df.prototype.H = function() {
		this.R.v = [];
		for (var a = {}, b = 0; b < this.S.length; a = {
				tc: a.tc
			}, b++) a.tc = this.S[b], E(this.R, this.ma + Math.random() * this.T, function(a) {
			return function() {
				return a.tc.H()
			}
		}(a))
	...
	ef.prototype.H = function() {
		this.S.R = [];
		for (var a = 0, b = {}, c = k(this.R), d = c.next(); !d.done; b = {
				step: b.step
			}, d = c.next()) b.step = d.value, F(this.S, 100 * a++, function(a) {
			return function() {
				return a.step.H()
			}
		}(b))
	...
	var Hf = {},
		If = (Hf[0] = function() {
			return {
				Vb: Ff(18 + 2.5 * (Math.random() - .5), 85, -91),
				Ub: 0,
				Mb: .7
			}
		}, Hf[1] = function() {
			return {
				Vb: Ff(18.5 + 2.5 * (Math.random() - .5), 89, -95),
				Ub: 3,
				Mb: .7
			}
		}, Hf[2] = function() {
			return {
				Vb: Ff(18.5 + 2.5 * (Math.random() - .5), 87, -89),
				Ub: -2,
				Mb: .7
			}
		}, Hf[3] = function() {
	...
	function Rf(a) {
		...
		a.R.v = [];
		E(a.R, 100);
		D(a.R, new I(100, 1, 0, n, function(b) {
			a.v.U = b
		}));
		E(a.R, 0, function() {
			a.v.H = !1
	...
	function cg(a) {
		...
		a.v ? document.addEventListener(a.v, a.H, !1) : b && b.registerPageVisibilityListener && (google.doodle || (google.doodle = {}), google.doodle.pvc = function() {
			a.H && a.H()
		}, b.registerPageVisibilityListener("google.doodle.pvc();"))
	}

	function dg(a, b) {
		window.agsa_ext ? b() : a.$ = window.setTimeout(function() {
			ag(a)
		}, 100)
	}
		...
		this.R = function(d) {
			if ("contextmenu" == d.type) d.preventDefault();
				...
				var f = b,
					...
					y = 0;
				if (f) {
					do t += f.offsetLeft, y += f.offsetTop; while (f = f.offsetParent)
				}
				f = [t, y];
				f = [e[0] - f[0], e[1] - f[1]];
	...
	function xg() {
		...
		for (var b = {
				...
				i: b.i
			}, b.i++) F(this.v, 50 * b.i, function(b) {
			return function() {
	...
	function Ng() {
		null == Ag && (Ag = Kb && !Ob ? Dg : Lb ? Eg : m(Gb, "Gbot") ? Fg : document.getElementById("fkbx") && !Mb ? Gg : Pb() ? Hg : document.querySelector("body.hp") ? Mb ? Cg : Bg : Ob ? Mb ? Jg : Ig : Mb ? Kg : Lg)
	};
	...
	Rg.prototype.Za = function(a, b) {
		...
		if (4 == a) {
			...
			for (var e = 1; e <= b; a = {
					j: a.j
				}, e++) a.j = e, E(this.ka, 150, function(a) {
				return function() {
					Kf(c.W, d + a.j);
	...
	function dh(a, b) {
		b != a.W && (a.W = b, a.v.v = [], a.v.R = [], 2 != b && z(a.va), a.Ca = !1, a.ha.H = !1, Z(a.Aa, !1), Z(a.ra, !1), Z(a.wa, !1), 0 == b || 2 == b ? (Z(a.V, !1), Z(a.ka, !1), Z(a.U, !1), D(a.v, [new J(a.$, 500, new v(0, 150, 0), {
			Ha: uc
		}), new J(a.T, 500, new v(0, 0, 0), {
			Ha: uc
		})]), 2 == b && E(a.v, 0, function() {
			...
			Z(a.T, !0)
		})) : 1 == b && (Z(a.T, !1), a.$.Da(0, 0, 0), A(a.V, 0), A(a.ka,
			0), A(a.U, 0), G(a.v, new J(a.T, 500, new v(0, 150, 0), {
			Ha: uc
		})), E(a.v, 1E3, function() {
			G(a.v, new I(200, 0, 1, n, function(b) {
				return A(a.ka, b)
	...
	function ah(a, b, c, d) {
		K.call(this, void 0 === b ? 0 : b, void 0 === c ? 0 : c, void 0 === d ? 0 : d)
	}
	h(ah, K);
	...
	gh.prototype.Za = function(a, b) {
		4 == a ? (this.H += b, Tg.s = this.H) : 2 == a ? (Vg(2), Ug(4), this.H = 0, Tg.s = this.H) : 13 == a ? Vg(3) : 5 == a ? (Vg(4), Vg(0), Ug(5)) : 16 == a ? Tg.d2 = Math.round(b) : 12 == a ? (Vg(0), Ug(3)) : 19 == a && Ug(2)
	};
	ra(gh);
	...
	function jh(a) {
		D(a.R, [new I(300, 0, 1, n, function(b) {
			a.v.U = b
	...
	function kh(a) {
		...
		D(a.R, [new I(300, 1, 0, n, function(b) {
			a.v.U = b
	...
	function lh(a) {
		...
		x(a, this);
		a = new Q(kc, Jc(new v(3.66, 0, 11.28)), {
			fillStyle: "tan"
		});
		x(a, this);
		a = new Q(new v(0, 0, 5.64), Jc(new v(3.66, 0, 11.28)), {
		...
		b = new Q(new v(-1.32, 0, -10.06 + .075), Jc(a), {
			fillStyle: "rgba(255,255,255,0.3)"
		});
		x(b, this);
		b = new Q(new v(-1.32, 0, 10.06 - .075), Jc(a), {
		...
		x(b, this);
		a = new Q(new v(1.32, 0, 10.06 - .075), Jc(a), {
			fillStyle: "rgba(255,255,255,0.3)"
		});
		x(a, this);
		a = Math.PI;
		...
		for (d = 0; d < c + 1; d++) {
			var e = 112 * Math.cos(a - (d + 1) / c * (b - a)),
				...
				e = new Q(new v(0, 0, 0), [new v(e, 0, f), new v(l, 0, p), new v(l, 6, p), new v(e, 6, f)], {
					fillStyle: "#F9EC31"
				});
			x(e, this)
		}
		...
		c = 20;
		for (d = 0; d < c + 1; d++) e = 72 * Math.cos(a - (d + 1) / c * (b - a)), f = 72 * Math.sin(a - (d + 1) / c * (b - a)), l = 72 * Math.cos(a - d / c * (b - a)), p = 72 * Math.sin(a - d / c * (b - a)), e = new Q(new v(0, 0, 0), [new v(e, 0, f), new v(l, 0, p), new v(l, 1, p), new v(e, 1, f)], {
			fillStyle: "white"
		}), x(e, this);
		Fc(N.qa(), this);
		this.v = new C;
	...
	lh.prototype.Za = function(a, b) {
		if (10 == a || 11 == a || 4 == a) {
			this.v.R = [];
			for (var c = {}, d = k(this.R), e = d.next(); !e.done; c = {
					kc: c.kc,
					target: c.target,
					action: c.action,
					Dc: c.Dc
				}, e = d.next()) c.kc = e.value, c.target = .04 + .04 * Math.random(), c.Dc = 4 == a ? 7 + Math.floor(5 * Math.random()) : 12, c.action = new ab(4 == a ? Math.max(2E3, 500 * b) : 5E3, function(a) {
				return function() {
					var b = a.action;
	...
	function ph(a, b) {
		if (6 == a.v && 6 != b) qh(a), a.v = b;
			...
			G(a.R, new I(100, r(a.V.W), oh[b], n, function(b) {
				a.V.W = q(b)
			}))
		}
	}
	...
	function sh(a, b, c) {
		3 != a.v && 4 != a.v && 5 != a.v && 6 != a.v && 2 != b.getState() && a.Bb && (0 == a.v && ph(a, 1), ph(a, 2), c && W().Qc(), Rf(a.V), a.Bb = !1, F(a.R, 200, function() {
			return a.Bb = !0
		}), c = B(b).z - B(a).z, 3 >= Math.abs(c) && 1 == b.getState() ? (Ef(b, c / 3), E(a.R, 200, function() {
			2 == a.v && ph(a, 0)
		})) : 3 < c && 4 > c && 1 == b.getState() ? E(a.R, 100, function() {
			return Ef(b, 1)
		}) : E(a.R, 200, function() {
			return ph(a, 1)
		}))
	...
	function rh(a) {
		...
		ke(a, 1.2, 1.2);
		z(a.$);
		D(a.R, new I(100, 1.2, 1, n, function(b) {
			ke(a, 1.2, b)
		}));
		D(a.R, new I(100, 1, 1.5, n, function(b) {
			ke(a, b, b)
		}));
		E(a.R, 0, function() {
			je(a, xd);
	...
	function qh(a) {
		...
		S(a, .05, -.5);
		ke(a, 1.2, 1.4);
		D(a.R, new I(100, 1.4, 1, n, function(b) {
			ke(a, 1.2, b)
		}));
		D(a.R, new I(100, 1, 1.2, n, function(b) {
			ke(a, 1.2, b)
		}));
		E(a.R, 0, function() {
			S(a, 0, -.5);
	...
	function zh(a, b) {
		...
		this.Gb.H = ch(this.W);
		Qe(this, this.Gb);
		this.hc = new eh(this.La, [32], function(a) {
			32 == a.which && (a = c.W, 0 == a.W || 2 == a.W ? Xf(a.T, !0) : 1 == a.W && Xf(a.U, !0))
		}, function(a) {
			32 == a.which && (a = c.W, 0 == a.W || 2 == a.W ? Xf(a.T, !1) : 1 == a.W && Xf(a.U, !1))
		});
		Qe(this, this.hc);
	...
	function Ch(a) {
		...
		x(a.ma, Hc.H);
		a.S = 2;
		D(a.R, [new J(a.H, 2E3, fc, {
			Ha: vc
		}), new I(2E3, r(a.H.R), 0, n, function(b) {
			return Ac(a.H, b)
		}, {
			Ha: vc
		})]);
	...
	zh.prototype.Za = function(a, b) {
		...
		else if (4 == a) this.$ = Math.min(this.$ + .01 * b, 2), this.Ja = 0, this.Lb = !0, z(this.Ua), z(this.Va), F(this.R, 200, function() {
			yc(c.H, 0)
		}), 6 == b && E(this.R, 4E3);
